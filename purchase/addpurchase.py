...
class AddPurchaseWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        left_wrapper_widget.setFixedWidth(500)
        ...
        netamount_row.addWidget(net_amount)
        netamount_row.addWidget(self.net_amountdata)
        ...
        total_row.addWidget(lefttotal)
        total_row.addWidget(self.lefttotaldata)
        ...
        right_wrapper_widget.setFixedWidth(500)
        
        
        right_total_row = QHBoxLayout()
        right_total = QLabel("Total")
        self.right_totaldata = QLabel("0.00")
        right_total_row.addWidget(right_total)
        right_total_row.addWidget(self.right_totaldata)
        ...
        roundoff_row.addWidget(roundofflabel)
        roundoff_row.addWidget(self.roundoffdata)
        ...
        payment_method_row.addWidget(payment_method_label)
        payment_method_row.addWidget(self.payment_method_combo)
        ...
        payment_row.addWidget(paidlabel)
        payment_row.addWidget(self.paidedit)
