from PySide6.QtWidgets import QWidget, QPushButton, QLabel, QVBoxLayout, QHBoxLayout, QFrame, QSizePolicy, QGridLayout

from medic.utilities.stylus import load_stylesheets
from medic.utilities.app_messagebox import AppMessageBox
from medic.features.finance.services.party_transaction_service import fetch_customer_transaction_detail
...
class CustomerTransactionDetailWidget(QWidget):
    ...
    def load_data(self, transaction_id):
        try:
            row = fetch_customer_transaction_detail(transaction_id)
        ...
        self.customer_name.setText(str(row["customer_name"] or "Walk-in Customer"))
        self.customer_contact.setText(str(row["customer_contact"] or "-"))
        self.salesman.setText(str(row["salesman_name"] or "-"))
