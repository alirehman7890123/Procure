...
from features.inventory.services.stock_adjustment_service import (
...
from features.inventory.services.product_catalog_service import (
    build_product_stock_filter_clause,
    fetch_expired_product_rows,
    fetch_low_stock_rows,
    fetch_master_catalog_rows,
    fetch_product_by_barcode,
    fetch_product_listing_page,
    fetch_used_product_count,
    search_products,
)
from features.inventory.services.product_admin_service import (
...
class ProductListWidget(QWidget):
    ...
    def open_master_catalog_dialog(self):
        try:
            catalog_data = fetch_master_catalog_rows()
        ...
        manufacturer_count_value = QLabel(str(catalog_data["manufacturer_count"]))
        ...
        rows_loaded = 0
        for row_data in catalog_data["rows"]:
            ...
            values = [
                ...
                row_data["packing"],
                row_data["size"],
                row_data["manufacturer_id"],
                row_data["manufacturer_name"],
            ]
