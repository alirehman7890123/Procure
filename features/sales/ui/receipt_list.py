...
from features.sales.services.sales_detail_service import fetch_sales_receipt_list_rows
...
class ReceiptListWidget(QWidget):
    ...
    def load_sales_into_table(self):
        ...
        try:
            rows = fetch_sales_receipt_list_rows(
                date_from=from_date,
                date_to=to_date,
        ...
        for row_data in rows:
            ...
            sales_id = row_data["sales_id"]
            customer = row_data["customer_name"]
            products = row_data["products"]
            received = row_data["received"]
            creation = row_data["creation_date"]
