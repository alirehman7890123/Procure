...
- `customer/basecustomer.py`, `customer/addcustomer.py`, `customer/customerlist.py`, and `customer/customerdetail.py` are now compatibility shims that re-export the feature-owned customer screens while the remaining people/entity domains are migrated
...
- `supplier/basesupplier.py`, `supplier/addsupplier.py`, `supplier/supplierlist.py`, and `supplier/supplierdetail.py` are now compatibility shims that re-export the feature-owned supplier screens while the remaining people/entity domains are migrated
...
- `employee/baseemployee.py`, `employee/addemployee.py`, `employee/employeelist.py`, and `employee/employeedetails.py` are now compatibility shims that re-export the feature-owned employee screens while the remaining people/entity domains are migrated
...
- `salesrep/basesalesrep.py`, `salesrep/addsalesrep.py`, `salesrep/salesreplist.py`, and `salesrep/salesrepdetail.py` are now compatibility shims that re-export the feature-owned sales-rep screens
...
- `purchasereturn/base_purchase_return.py`, `purchasereturn/create_purchase_return.py`, `purchasereturn/purchase_return_list.py`, and `purchasereturn/purchase_return_detail.py` are now compatibility shims that re-export the feature-owned purchase-return screens
...
- `salesreturn/base_sales_return.py`, `salesreturn/create_sales_return.py`, `salesreturn/sales_return_list.py`, and `salesreturn/sales_return_detail.py` are now compatibility shims that re-export the feature-owned sales-return screens
...
- `payroll/basepayroll.py`, `payroll/addpayroll.py`, `payroll/payrolllist.py`, `payroll/payrolldetail.py`, `payroll/attendance.py`, `payroll/attendancelist.py`, `payroll/salaryadvance.py`, and `payroll/advancelist.py` are now compatibility shims that re-export the feature-owned payroll screens
