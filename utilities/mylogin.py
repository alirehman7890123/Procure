...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.header_widget.setStyleSheet("""background-color: #fff; border-bottom: 3px solid #333;""")
        ...
        business_title.setStyleSheet("color: #47034E; border:none; font-family: 'arial'; font-size: 20px; margin-left: 20px; font-weight: 700;")
