...
class CreateSalesWidget(QWidget):
    ...
    def populate_salesmen(self):
        ...
        if query.exec("SELECT id, name FROM employee WHERE status = 'active';"):
            ...
            while query.next():
                ...
                employee_name = query.value(1)

                print(employee_id, employee_name)

                self.salesman.addItem(employee_name, employee_id)  # Text shown, ID stored as data
    ...
    def insert_salesreceipt(self):
        ...
        if confirmation:
            ...
            try:
                ...
                customername = self.customer.currentText()
    ...
    def update_amount(self, edited_widget):
        ...
        try:
            ...
            self.table.cellWidget(row, 7).setText(str(amount))
    ...
    def update_final_amount(self):
        ...
        self.discountamount.setText(f"{discountamount:.2f}")
        
        rem_amount = subtotal - discountamount
        self.netamount.setText(f"{rem_amount:.2f}")
        ...
        self.total.setText(f"{totalamount:.2f}")
