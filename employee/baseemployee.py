...
from medic.employee.addemployee import AddEmployeeWidget
from medic.employee.employeelist import EmployeeListWidget
from medic.employee.employeedetails import EmployeeDetailWidget
