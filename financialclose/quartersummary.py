...
from services.financial_closing_service import get_quarter_summary
...
class FinancialQuarterSummaryPage(QWidget):
    ...
    def load_quarter_summary(self, quarter_label):
        ...
        self.summary_intro.setText(
            "This is a derived summary built from the three closed months in the selected quarter."
        )
